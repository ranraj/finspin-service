...
export class TileComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['id', 'color', 'positionMode', 'displaySize', 'displayMode'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  trackId(_index: number, item: ITile): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITile[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
