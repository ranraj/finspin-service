...
export class SprintComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['id', 'name', 'code'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  trackId(_index: number, item: ISprint): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: ISprint[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
