...
export class BoardComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['id', 'title', 'uid'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  trackId(_index: number, item: IBoard): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBoard[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
