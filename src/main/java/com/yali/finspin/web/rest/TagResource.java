...
/**
 * REST controller for managing {@link com.yali.finspin.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
     ...
     */
    @PostMapping("/tags")
    public Mono<ResponseEntity<TagDTO>> createTag(@RequestBody TagDTO tagDTO) throws URISyntaxException {
     ...
     */
    @GetMapping("/tags")
    public Mono<List<TagDTO>> getAllTags(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
     ...
     */
    @GetMapping("/tags/{id}")
    public Mono<ResponseEntity<TagDTO>> getTag(@PathVariable String id) {
    ...
    public Mono<List<TagDTO>> searchTags(@RequestParam String query) {
        log.debug("REST request to search Tags for query {}", query);
        return tagService.search(query).collectList();
    }
}
